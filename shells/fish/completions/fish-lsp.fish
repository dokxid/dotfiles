...
#
#      >_ yarn install && yarn dev                            # builds and links the `fish-lsp` command globally (with completions)
...
###############################################################################################
### generated output time:      11/1/25, 4:11:56 AM                                         ###
### binary build time:          10/1/25, 2:01:36 PM                                         ###
### binary build path:          ~/.bun/install/global/node_modules/fish-lsp/dist/fish-lsp   ###
### binary build version:       1.1.0                                                       ###
